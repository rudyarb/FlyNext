...
INSERT INTO "new_HotelBooking" ("bookingDate", "checkInDate", "checkOutDate", "hotelId", "id", "itineraryId", "status", "userId") SELECT "bookingDate", "checkInDate", "checkOutDate", "hotelId", "id", "itineraryId", "status", "userId" FROM "HotelBooking";
...
INSERT INTO "new_Room" ("amenities", "hotelId", "id", "images", "pricePerNight") SELECT "amenities", "hotelId", "id", "images", "pricePerNight" FROM "Room";
DROP TABLE "Room";
